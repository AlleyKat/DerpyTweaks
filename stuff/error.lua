...
if V.error ~= true then return end

---- SETTING HERE ---- ---- ---- ---- ----
local nfont = [=[Interface\AddOns\DerpyMedia\media\standart.ttf]=] -- This is the font`s of all errors
...
local Yoffset = -136 -- "y" layout coordinate ("VERTICAL") - Zero starts from TOP-CENTER of ur monitor
...
local holdtime = 1.4 -- hold time (seconds)
local fadeintime = 0.08 -- fadein time (seconds)
local fadeouttime = 0.18 -- fade out time (seconds)
-------------------------------------------
